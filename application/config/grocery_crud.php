<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $config['grocery_crud_default_language'] = 'turkish';
    ...
    $config['grocery_crud_file_upload_allow_file_types'] = 'jpeg|jpg|png|xls|docx|doc|pdf|xlsx|xls';
    $config['grocery_crud_file_upload_max_file_size'] = '1MB'; //ex. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)
