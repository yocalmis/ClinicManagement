...
//2 cari alacaklandır
	      ...
	      function sss_getir()
    {
        ...
        else
        {
            return FALSE;
	     	 ...
	     	 function yetki_kontrol_gorusme($kul_id,$id) 
     { 		 
     ...
     { 		 
        ...
        else
        {
	   	 ...
	   	 function yetki_kontrol_arama($kul_id,$id) 
     { 		 
        ...
        else
        {
            return FALSE;
	    	 ...
	    	 function yetki_kontrol_randevu($kul_id,$id) 
     { 		 
        ...
        else
        {
            return FALSE;
	 			...
	 			function bugun_tahsilat( $bugun_bas,$bugun_bit ) {
			...
			function bugun_odeme( $bugun_bas,$bugun_bit ) {
			...
			function bugun_gelir( $bugun_bas,$bugun_bit ) {
			...
			function bugun_gider( $bugun_bas,$bugun_bit ) {
			...
			function bugun_alis( $bugun_bas,$bugun_bit ) {
			...
			function bugun_satis( $bugun_bas,$bugun_bit ) {
			...
			function buh_tahsilat( $buhafta,$bugun_bit ) {
			...
			function buh_odeme( $buhafta,$bugun_bit ) {
			...
			function buh_gelir( $buhafta,$bugun_bit ) {
			...
			function buh_gider( $buhafta,$bugun_bit ) {
			...
			function buh_alis( $buhafta,$bugun_bit ) {
			...
			function buh_satis( $buhafta,$bugun_bit ) {
			...
			function buay_tahsilat( $buay,$bugun_bit ) {
			...
			function buay_odeme( $buay,$bugun_bit ) {
			...
			function buay_gelir( $buay,$bugun_bit ) {
			...
			function buay_gider( $buay,$bugun_bit ) {
			...
			function buay_alis( $buay,$bugun_bit ) {
			...
			function buay_satis( $buay,$bugun_bit ) {
			...
			function buyil_tahsilat( $buyil,$bugun_bit ) {
			...
			function buyil_odeme( $buyil,$bugun_bit ) {
			...
			function buyil_gelir( $buyil,$bugun_bit ) {
			...
			function buyil_gider( $buyil,$bugun_bit ) {
			...
			function buyil_alis( $buyil,$bugun_bit ) {
			...
			function buyil_satis( $buyil,$bugun_bit ) {
			...
			//+$this->genel_durum_giris($buyil,$bugun_bit)-$this->genel_durum_cikis($buyil,$bugun_bit);
				...
				function kasa_durum_giris( $buyil,$bugun_bit ) {
			...
			return $query->row()->tutar;
					...
					function kasa_durum_cikis( $buyil,$bugun_bit ) {
			...
			//+$this->genel_durum_giris($buyil,$bugun_bit)-$this->genel_durum_cikis($buyil,$bugun_bit);
	    	 ...
	    	 function yetki_kontrol_protocol($kul_id,$id) 
     { 		 
    ...
    { 
        ...
        else
        {
	      ...
	      function fat_kayit($fat_turu,$ara_toplam,$indirim,$vergi,$toplam,$mus,$seri,$no,$duz_ta,$va_ta,$ack,$kul_id)
    { 
	...
	return $this->db->insert_id();	  
	     ...
	     function islem_kayit_fat($is_t,$rel_t,$fat_id,$gir_cik,$toplam,$duz_ta,$ack,$mus,$kul_id)
    { 
	...
	return $this->db->insert_id();	  
	 	      ...
	 	      function fat_item_kayit($fat_id,$item,$qty,$prc,$total,$des,$discount,$tax,$kul_id)
    { 
