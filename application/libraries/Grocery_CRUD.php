		...
		if($field_info->extras == 'text_editor')
		{
			...
			switch ($editor) {
				...
				case 'ckeditor4':
					...
					$this->set_js_config($this->default_texteditor_path.'/ckeditor4/config.js');
				break;
				...
				case 'tinymce5':
					$this->set_js_lib($this->default_texteditor_path.'/tinymce/tinymce.min.js');
				break;

				case 'froala':
					$this->set_css($this->default_texteditor_path.'/froala/font-awesome/font-awesome.min.css');
					$this->set_css($this->default_texteditor_path.'/froala/froala_editor.min.css');
					$this->set_css($this->default_texteditor_path.'/froala/froala_style.min.css');
					$this->set_js_lib($this->default_texteditor_path.'/froala/froala_editor.min.js');
					$this->set_js_config($this->default_texteditor_path.'/froala/font_family.min.js');
					$this->set_js_config($this->default_texteditor_path.'/froala/font_size.min.js');
					$this->set_js_config($this->default_texteditor_path.'/froala/inline_style.min.js');
					$this->set_js_config($this->default_texteditor_path.'/froala/lists.min.js');
...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	const	JQUERY 			= "jquery-3.4.1.min.js";
