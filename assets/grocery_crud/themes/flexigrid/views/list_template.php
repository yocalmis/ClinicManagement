...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
			<input placeholder="<?php echo $this->l('list_search');?>" type="text" class="qsbsearch_fieldox search_text" name="search_text" size="30" id='search_text'>
